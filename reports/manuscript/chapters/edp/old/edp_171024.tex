...
\label{s:lineage}
   ...
   \subsubsection{A heuristic explanation of the deterministic model} In \cite{robert2018mutation}, the authors observe severals trajectories of a multiplicative compound Poisson process 
   \begin{equation*}
...
We observe that 
    \begin{align*}
        ...
        \eqfinp
    \end{align*}
    The sign of $[K(s_+)-1 -  \mu s_+ K'(s_+)]$ implies the exponential growth or decay of $u(t, x)$. 

    \begin{remark}
    We have defined above $s_*$ as the minimum of $K$ on $(0, \infty)$. On the curve $\Ccal_{s_*}$ defined by $s_+(t, x) = s_*$ it follows that 
    \begin{align*}
    ...
    Similarly, On the curve $\Ccal_{1}$ defined by $s_+(t, x) = 1$ it follows that 
    \begin{align*}
        K(1)-1 -  \mu K'(1) = \mu K'(1)
        \eqfinp
    \end{align*}
